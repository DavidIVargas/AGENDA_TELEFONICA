...
public class VentanaActualizarOperadora extends javax.swing.JInternalFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        Operadora operadora = operadoraControlador.buscarOperadora(codigo);

        if (operadora != null) {
            txtNombre.setText(operadora.getNombre());
            btnAceptar.setEnabled(true);
        } else {
            JOptionPane.showMessageDialog(this, "Operadora no encontrada.", "Error", JOptionPane.ERROR_MESSAGE);
            txtNombre.setText("");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (operadoraControlador.actualizarOperadora(codigo, nombre)) {
            JOptionPane.showMessageDialog(this, "Operadora actualizada correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            setVisible(false);
        } else {
            JOptionPane.showMessageDialog(this, "La operadora no ha sido actualizada.", "Error", JOptionPane.ERROR_MESSAGE);
        }
