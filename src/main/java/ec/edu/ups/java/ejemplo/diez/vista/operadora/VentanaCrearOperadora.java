...
public class VentanaCrearOperadora extends javax.swing.JInternalFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        try {
            ...
            Operadora operadora = new Operadora(codigo, nombre);
            operadoraControlador.crear(operadora);

            JOptionPane.showMessageDialog(this, "Operadora creada exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            limpiarCampos();

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Ingrese un valor numérico válido para el código", "Error", JOptionPane.ERROR_MESSAGE);
        }
