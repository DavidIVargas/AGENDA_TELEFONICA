...
public class VentanaEliminarOperadora extends javax.swing.JInternalFrame {
    ...
    int respuesta = JOptionPane.showConfirmDialog(this, "¿Estás seguro de que deseas eliminar la operadora?");
    if (respuesta == JOptionPane.YES_OPTION) {
        if (operadoraControlador.eliminarOperadora(codigo)) {
            JOptionPane.showMessageDialog(this, "La operadora ha sido eliminada exitosamente.");
            limpiarCampos();
        } else {
            JOptionPane.showMessageDialog(this, "No se pudo eliminar la operadora.");
        }
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(respuesta == JOptionPane.YES_OPTION){
            if(operadoraControlador.eliminarOperadora(cedula)){
