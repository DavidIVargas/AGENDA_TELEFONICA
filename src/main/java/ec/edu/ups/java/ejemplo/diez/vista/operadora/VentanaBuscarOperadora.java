...
public class VentanaBuscarOperadora extends javax.swing.JInternalFrame {
    ...
    public VentanaBuscarOperadora(OperadoraControlador operadoraControlador) {
        initComponents();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (codigo.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Ingrese el código", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
